...
//***************************PART1:ON/OFF define*******************************
#define GTP_CUSTOM_CFG        1   //add by zhanghui
...
extern unsigned int GTP_RST_PORT;     //S5PV210_GPJ3(6)
extern unsigned int GTP_INT_PORT;    //S5PV210_GPH1(3)
...
#define GTP_I2C_NAME          "Good9XX-TS"
