...
#define RT3261_G_BST2_RM_L_MASK			(0x7 << 7)
#define RT3261_G_BST2_RM_L_SFT			7
#define RT3261_G_BST3_RM_L_MASK			(0x7 << 1)
#define RT3261_G_BST3_RM_L_SFT			1
...
#define RT3261_M_BST2_RM_L			(0x1 << 4)
#define RT3261_M_BST2_RM_L_SFT			4
#define RT3261_M_BST3_RM_L			(0x1 << 2)
#define RT3261_M_BST3_RM_L_SFT			2
...
#define RT3261_G_BST2_RM_R_MASK			(0x7 << 7)
#define RT3261_G_BST2_RM_R_SFT			7
#define RT3261_G_BST3_RM_R_MASK			(0x7 << 1)
#define RT3261_G_BST3_RM_R_SFT			1
...
#define RT3261_M_BST2_RM_R			(0x1 << 4)
#define RT3261_M_BST2_RM_R_SFT			4
#define RT3261_M_BST3_RM_R			(0x1 << 2)
#define RT3261_M_BST3_RM_R_SFT			2
...
#define RT3261_M_BST3_OM_L			(0x1 << 6)
#define RT3261_M_BST3_OM_L_SFT			6
...
#define RT3261_G_BST2_OM_R_MASK			(0x7 << 13)
#define RT3261_G_BST2_OM_R_SFT			13
#define RT3261_G_BST3_OM_R_MASK			(0x7 << 10)
#define RT3261_G_BST3_OM_R_SFT			10
...
#define RT3261_M_BST2_OM_R			(0x1 << 7)
#define RT3261_M_BST2_OM_R_SFT			7
#define RT3261_M_BST3_OM_R			(0x1 << 6)
#define RT3261_M_BST3_OM_R_SFT			6
...
#define RT3261_PWR_BST3				(0x1 << 14)
#define RT3261_PWR_BST3_BIT			14
#define RT3261_PWR_BST2				(0x1 << 12)
#define RT3261_PWR_BST2_BIT			12
...
int rt3261_conn_mux_path(struct snd_soc_codec *codec, char *widget_name,
			 char *path_name);
int rt3261_headset_detect(struct snd_soc_codec *codec, int jack_insert);
