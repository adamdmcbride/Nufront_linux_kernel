...
#include "rt3261.h"
#if defined(CONFIG_SND_SOC_RT3261_MODULE) || defined(CONFIG_SND_SOC_RT3261)
#include "rt3261-dsp.h"
#endif

#define RT3261_REG_RW 1		/* for debug */
#define RT3261_DET_EXT_MIC 0
#define RT3261_MICBIAS_ALWAYS_ENABLE 1
#define USE_ONEBIT_DEPOP 1	/* for one bit depop */
#define VERSION "0.5.3 alsa 1.0.24"
...
static struct rt3261_init_reg init_list[] = {
	{RT3261_GEN_CTRL1, 0x3771},	//fa[12:13] = 1'b; fa[8~10]=1; fa[0]=1
	{RT3261_ADDA_CLK1, 0x1614},	//73[2] = 1'b
	...
	{RT3261_MONO_DAC_MIXER, 0x4454},	//Dig inf 2 -> Mono DAC mixer -> DACL2
	...
	{RT3261_SPK_L_MIXER, 0x003C},	//DACL1 -> SPKMIXL
	{RT3261_SPK_R_MIXER, 0x003C},	//DACR1 -> SPKMIXR
	{RT3261_SPK_VOL, 0x8888},	//SPKMIX -> SPKVOL
	{RT3261_SPO_CLSD_RATIO, 0x0001},
	{RT3261_SPO_L_MIXER, 0xC800},	//SPKVOLL SPKVOLR -> SPOLMIX
	{RT3261_SPO_R_MIXER, 0x2800},	//SPKVOLR -> SPORMIX
	//      {RT3261_I2S1_SDP        , 0xD000},//change IIS1 and IIS2
	/*record */
	{RT3261_IN1_IN2, 0x50C0},	//IN1 boost 40db and differential mode
	{RT3261_IN3_IN4, 0x0500},	//IN2 boost 40db and signal ended mode
	{RT3261_REC_L2_MIXER, 0x006d},	//Mic1 -> RECMIXL
	{RT3261_REC_R2_MIXER, 0x005f},	//Mic1 -> RECMIXR
	{RT3261_STO_ADC_MIXER, 0x3820},	//ADC -> Sto ADC mixer
	//#if RT3261_DET_EXT_MIC
	//      {RT3261_MICBIAS         , 0x3800},/* enable MICBIAS short current */
	//      {RT3261_GPIO_CTRL1      , 0x8400},/* set GPIO1 to IRQ */
	{RT3261_GPIO_CTRL3, 0x0024},	/* set GPIO1 output */
	//      {RT3261_IRQ_CTRL2       , 0x8000},/*set MICBIAS short current to IRQ */
	/*( if sticky set regBE : 8800 ) */
	//#endif
	//SPKVDD auto detect
	{RT3261_PRIV_INDEX, 0x001c},
	{RT3261_PRIV_DATA, 0xfd38},
	{RT3261_PV_DET_SPK_G, 0xC000},	//SPKVDD detection and SPK Amp auto ratio gain

	{RT3261_ADC_DATA, 0x0f0f},
	{RT3261_DIG_INF_DATA, 0x0a00},
	{RT3261_ADC_BST_VOL, 0x5000},
	//ASRC
	{RT3261_JD_CTRL, 0x0003},
	{RT3261_ASRC_1, 0x9800},
	{RT3261_ASRC_2, 0x3820},
	//3g Record
	{RT3261_PRIV_INDEX, 0x003f},
	{RT3261_PRIV_DATA, 0x4000},
	{RT3261_DUMMY_PR3F, 0x4000},
	{RT3261_DIG_MIXER, 0x8800},
};
 ...
 */
static int rt3261_index_write(struct snd_soc_codec *codec, unsigned int reg,
			      unsigned int value)
{
	int ret;
 ...
 */
static unsigned int rt3261_index_read(struct snd_soc_codec *codec,
				      unsigned int reg)
{
	int ret;
				    ...
				    unsigned int value)
{
	...
	if (change) {
		...
		if (ret < 0) {
			dev_err(codec->dev, "Failed to write private reg: %d\n",
				ret);
			goto err;
		}
	}
...
static int rt3261_volatile_register(struct snd_soc_codec *codec,
				    unsigned int reg)
{
	switch (reg) {
	case RT3261_RESET:
...
static int rt3261_readable_register(struct snd_soc_codec *codec,
				    unsigned int reg)
{
	switch (reg) {
	case RT3261_RESET:
...
void DC_Calibrate(struct snd_soc_codec *codec)
{
	...
	sclk_src = snd_soc_read(codec, RT3261_GLB_CLK) & RT3261_SCLK_SRC_MASK;

	snd_soc_update_bits(codec, RT3261_PWR_ANLG2, RT3261_PWR_MB1,
			    RT3261_PWR_MB1);
	snd_soc_update_bits(codec, RT3261_DEPOP_M2, RT3261_DEPOP_MASK,
			    RT3261_DEPOP_MAN);
	snd_soc_update_bits(codec, RT3261_DEPOP_M1,
			    RT3261_HP_CP_MASK | RT3261_HP_SG_MASK |
			    RT3261_HP_CB_MASK,
			    RT3261_HP_CP_PU | RT3261_HP_SG_DIS |
			    RT3261_HP_CB_PU);
	...
	snd_soc_update_bits(codec, RT3261_PWR_ANLG2, RT3261_PWR_MB1, 0);
	snd_soc_update_bits(codec, RT3261_GLB_CLK, RT3261_SCLK_SRC_MASK,
			    sclk_src);
}
...
int rt3261_headset_detect(struct snd_soc_codec *codec, int jack_insert)
{
	...
	if (jack_insert) {
		...
		sclk_src =
		    snd_soc_read(codec, RT3261_GLB_CLK) & RT3261_SCLK_SRC_MASK;
		snd_soc_update_bits(codec, RT3261_GLB_CLK, RT3261_SCLK_SRC_MASK,
				    0x3 << RT3261_SCLK_SRC_SFT);
		snd_soc_update_bits(codec, RT3261_PWR_ANLG1, RT3261_PWR_LDO2,
				    RT3261_PWR_LDO2);
		snd_soc_update_bits(codec, RT3261_PWR_ANLG2, RT3261_PWR_MB1,
				    RT3261_PWR_MB1);
		snd_soc_update_bits(codec, RT3261_MICBIAS,
				    RT3261_MIC1_OVCD_MASK |
				    RT3261_MIC1_OVTH_MASK |
		...
		snd_soc_update_bits(codec, RT3261_IRQ_CTRL2, RT3261_MB1_OC_CLR,
				    0);
		snd_soc_update_bits(codec, RT3261_GLB_CLK, RT3261_SCLK_SRC_MASK,
				    sclk_src);
	} else {
...
void nusmart_rt3261_jack_event(struct snd_soc_codec *codec, int jack_insert)
{
	int jack_type;
	/*To be updated */
}

EXPORT_SYMBOL(nusmart_rt3261_jack_event);

static const char *rt3261_dacr2_src[] = { "TxDC_R", "TxDP_R" };

static const SOC_ENUM_SINGLE_DECL(rt3261_dacr2_enum, RT3261_DUMMY_PR3F, 14,
				  rt3261_dacr2_src);
			   ...
			   struct snd_ctl_elem_value *ucontrol)
{
	...
	case RT3261_DMIC_DIS:
		...
		snd_soc_update_bits(codec, RT3261_DMIC,
				    ...
				    RT3261_DMIC_1_DP_GPIO3 |
				    RT3261_DMIC_2_DP_GPIO4);
		snd_soc_update_bits(codec, RT3261_DMIC,
				    RT3261_DMIC_1_EN_MASK |
				    RT3261_DMIC_2_EN_MASK,
	...
	case RT3261_DMIC1:
		snd_soc_update_bits(codec, RT3261_GPIO_CTRL1,
				    RT3261_GP2_PIN_MASK | RT3261_GP3_PIN_MASK,
				    RT3261_GP2_PIN_DMIC1_SCL |
				    RT3261_GP3_PIN_DMIC1_SDA);
		snd_soc_update_bits(codec, RT3261_DMIC,
				    RT3261_DMIC_1L_LH_MASK |
				    RT3261_DMIC_1R_LH_MASK |
				    RT3261_DMIC_1_DP_MASK,
				    RT3261_DMIC_1L_LH_FALLING |
				    RT3261_DMIC_1R_LH_RISING |
				    RT3261_DMIC_1_DP_IN1P);
		snd_soc_update_bits(codec, RT3261_DMIC, RT3261_DMIC_1_EN_MASK,
				    RT3261_DMIC_1_EN);
		break;
	...
	case RT3261_DMIC2:
		snd_soc_update_bits(codec, RT3261_GPIO_CTRL1,
				    ...
				    RT3261_GP2_PIN_DMIC1_SCL |
				    RT3261_GP4_PIN_DMIC2_SDA);
		snd_soc_update_bits(codec, RT3261_DMIC,
				    RT3261_DMIC_2L_LH_MASK |
				    RT3261_DMIC_2R_LH_MASK |
				    RT3261_DMIC_2_DP_MASK,
				    RT3261_DMIC_2L_LH_FALLING |
				    RT3261_DMIC_2R_LH_RISING |
				    RT3261_DMIC_2_DP_IN1N);
		snd_soc_update_bits(codec, RT3261_DMIC, RT3261_DMIC_2_EN_MASK,
				    RT3261_DMIC_2_EN);
		break;
...
static const SOC_ENUM_SINGLE_DECL(rt3261_in1_mode_enum, RT3261_IN1_IN2,
				  RT3261_IN_SFT1, rt3261_input_mode);

static const SOC_ENUM_SINGLE_DECL(rt3261_in2_mode_enum, RT3261_IN3_IN4,
				  RT3261_IN_SFT2, rt3261_input_mode);

static const SOC_ENUM_SINGLE_DECL(rt3261_in3_mode_enum, RT3261_IN1_IN2,
				  RT3261_IN_SFT2, rt3261_input_mode);
...
static const char *rt3261_clsd_spk_ratio[] =
    { "1.94x", "2x", "2.11x", "2.22x", "2.33x", "2.44x", "2.55x", "2.66x",
"2.77x", "3.00x",
	"3.30x",
};

static const SOC_ENUM_SINGLE_DECL(rt3261_clsd_spk_ratio_enum, RT3261_CLS_D_OUT,
...
static const SOC_ENUM_SINGLE_DECL(rt3261_hp_mute_enum, 0, 0,
				  rt3261_hp_mute_mode);
				  ...
				  struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.integer.value[1] =
	    RT3261_VOL_RSCL_MAX - (val & RT3261_R_VOL_MASK);
			      ...
			      struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.integer.value[0] =
	    !((snd_soc_read(codec, RT3261_HP_VOL) & RT3261_L_MUTE) >>
	      RT3261_L_MUTE_SFT);
			      ...
			      struct snd_ctl_elem_value *ucontrol)
{
	...
	if (ucontrol->value.integer.value[0]) {
		...
		snd_soc_update_bits(codec, RT3261_DEPOP_M3,
				    ...
				    | (RT3261_CP_FQ_192_KHZ <<
				       RT3261_CP_FQ3_SFT));
		rt3261_index_write(codec, RT3261_MAMP_INT_REG2, 0xfc00);
		snd_soc_update_bits(codec, RT3261_DEPOP_M1,
				    RT3261_SMT_TRIG_MASK, RT3261_SMT_TRIG_EN);
		snd_soc_update_bits(codec, RT3261_DEPOP_M1, RT3261_RSTN_MASK,
				    RT3261_RSTN_EN);
		snd_soc_update_bits(codec, RT3261_DEPOP_M1,
				    RT3261_RSTN_MASK | RT3261_HP_L_SMT_MASK |
				    RT3261_HP_R_SMT_MASK,
				    RT3261_RSTN_DIS | RT3261_HP_L_SMT_EN |
				    RT3261_HP_R_SMT_EN);
		...
		rt3261_index_write(codec, RT3261_MAMP_INT_REG2, 0xfc00);
		snd_soc_update_bits(codec, RT3261_DEPOP_M1, RT3261_HP_SG_MASK,
				    RT3261_HP_SG_EN);
		snd_soc_update_bits(codec, RT3261_DEPOP_M1, RT3261_RSTP_MASK,
				    RT3261_RSTP_EN);
		snd_soc_update_bits(codec, RT3261_DEPOP_M1,
				    RT3261_RSTP_MASK | RT3261_HP_L_SMT_MASK |
				    RT3261_HP_R_SMT_MASK,
				    RT3261_RSTP_DIS | RT3261_HP_L_SMT_EN |
				    RT3261_HP_R_SMT_EN);
		/*bard 10-18 r
		   snd_soc_update_bits(codec, RT3261_HP_CALIB_AMP_DET,
...
static const struct snd_kcontrol_new rt3261_snd_controls[] = {
	...
	SOC_DOUBLE("Speaker Playback Volume Switch", RT3261_SPK_VOL,
	...
	SOC_DOUBLE_EXT_TLV("Speaker Playback Volume", RT3261_SPK_VOL,
			   ...
			   RT3261_VOL_RSCL_RANGE, 0,
			   rt3261_vol_rescale_get, rt3261_vol_rescale_put,
			   out_vol_tlv),
	/* Headphone Output Volume */
	SOC_DOUBLE("HP Playback Switch", RT3261_HP_VOL,
		   RT3261_L_MUTE_SFT, RT3261_R_MUTE_SFT, 1, 1),
	SOC_DOUBLE("HP Playback Volume Switch", RT3261_HP_VOL,
		   RT3261_VOL_L_SFT, RT3261_VOL_R_SFT, 1, 1),
	SOC_DOUBLE("HP Channel Switch", RT3261_HP_VOL,
		   RT3261_VOL_L_SFT, RT3261_VOL_R_SFT, 1, 1),
...
static const SOC_ENUM_SINGLE_DECL(rt3261_inl_enum, RT3261_INL_INR_VOL,
...
static const SOC_ENUM_SINGLE_DECL(rt3261_inr_enum, RT3261_INL_INR_VOL,
...
static const SOC_ENUM_SINGLE_DECL(rt3261_stereo_adc1_enum, RT3261_STO_ADC_MIXER,
...
static const SOC_ENUM_SINGLE_DECL(rt3261_stereo_adc2_enum, RT3261_STO_ADC_MIXER,
...
static const SOC_ENUM_SINGLE_DECL(rt3261_mono_adc_l1_enum,
				  RT3261_MONO_ADC_MIXER,
				  RT3261_MONO_ADC_L1_SRC_SFT,
				  rt3261_mono_adc_l1_src);
...
static const SOC_ENUM_SINGLE_DECL(rt3261_mono_adc_l2_enum,
				  RT3261_MONO_ADC_MIXER,
				  RT3261_MONO_ADC_L2_SRC_SFT,
				  rt3261_mono_adc_l2_src);
...
static const SOC_ENUM_SINGLE_DECL(rt3261_mono_adc_r1_enum,
				  RT3261_MONO_ADC_MIXER,
				  RT3261_MONO_ADC_R1_SRC_SFT,
				  rt3261_mono_adc_r1_src);
...
static const SOC_ENUM_SINGLE_DECL(rt3261_mono_adc_r2_enum,
				  RT3261_MONO_ADC_MIXER,
				  RT3261_MONO_ADC_R2_SRC_SFT,
				  rt3261_mono_adc_r2_src);
...
static const SOC_ENUM_SINGLE_DECL(rt3261_dac_r2_enum, RT3261_DSP_PATH2,
...
static const SOC_ENUM_SINGLE_DECL(rt3261_if2_adc_l_enum, RT3261_DSP_PATH2,
				  RT3261_IF2_ADC_L_SEL_SFT,
				  rt3261_if2_adc_l_src);
...
static const SOC_ENUM_SINGLE_DECL(rt3261_if2_adc_r_enum, RT3261_DSP_PATH2,
				  RT3261_IF2_ADC_R_SEL_SFT,
				  rt3261_if2_adc_r_src);
...
static const SOC_ENUM_SINGLE_DECL(rt3261_dai_iis_map_enum, RT3261_I2S1_SDP,
...
static const SOC_ENUM_SINGLE_DECL(rt3261_sdi_sel_enum, RT3261_I2S2_SDP,
			    ...
			    struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		rt3261_index_update_bits(codec, RT3261_CHOP_DAC_ADC, 0x1000,
					 0x1000);
		break;
				  ...
				  struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		snd_soc_update_bits(codec, RT3261_GEN_CTRL1, RT3261_M_MAMIX_L,
				    0);
		break;
				  ...
				  struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		snd_soc_update_bits(codec, RT3261_GEN_CTRL1, RT3261_M_MAMIX_R,
				    0);
		break;
	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_update_bits(codec, RT3261_GEN_CTRL1, RT3261_M_MAMIX_R,
...
static int class_d_on = 0;
static int rt3261_spk_l_event(struct snd_soc_dapm_widget *w,
			      struct snd_kcontrol *kcontrol, int event)
{
	struct snd_soc_codec *codec = w->codec;
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		if (class_d_on == 1) {
			...
			rt3261_index_update_bits(codec, RT3261_CLSD_INT_REG1,
						 0xf000, 0xf000);
		}
		snd_soc_update_bits(codec, RT3261_SPK_VOL, RT3261_L_MUTE, 0);
		break;

	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_update_bits(codec, RT3261_SPK_VOL, RT3261_L_MUTE,
				    RT3261_L_MUTE);
		class_d_on--;
		if (class_d_on == 0) {
			rt3261_index_update_bits(codec, RT3261_CLSD_INT_REG1,
...
static int rt3261_spk_r_event(struct snd_soc_dapm_widget *w,
			      struct snd_kcontrol *kcontrol, int event)
{
	struct snd_soc_codec *codec = w->codec;
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		snd_soc_update_bits(codec, RT3261_SPK_VOL, RT3261_R_MUTE, 0);
		break;

	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_update_bits(codec, RT3261_SPK_VOL, RT3261_R_MUTE,
				    RT3261_R_MUTE);
		class_d_on--;
		if (class_d_on == 0) {
			rt3261_index_update_bits(codec, RT3261_CLSD_INT_REG1,
...
static void rt3261_pmu_depop(struct snd_soc_codec *codec)
{
	...
	snd_soc_update_bits(codec, RT3261_CHARGE_PUMP, RT3261_PM_HP_MASK,
			    RT3261_PM_HP_HV);
	snd_soc_update_bits(codec, RT3261_DEPOP_M3,
			    RT3261_CP_FQ1_MASK | RT3261_CP_FQ2_MASK |
			    RT3261_CP_FQ3_MASK,
	...
	msleep(5);
	snd_soc_update_bits(codec, RT3261_HP_VOL, RT3261_L_MUTE | RT3261_R_MUTE,
			    0);
	msleep(65);
	//snd_soc_update_bits(codec, RT3261_HP_CALIB_AMP_DET,
	//      RT3261_HPD_PS_MASK, RT3261_HPD_PS_EN);
...
void hp_amp_power(struct snd_soc_codec *codec, int on)
{
	...
	if (on) {
		...
		if (hp_amp_power_count <= 0) {
			...
			snd_soc_update_bits(codec, RT3261_DEPOP_M1,
					    RT3261_SMT_TRIG_MASK |
					    RT3261_HP_CD_PD_MASK |
					    RT3261_HP_CO_MASK |
					    RT3261_HP_CP_MASK |
					    RT3261_HP_SG_MASK |
					    RT3261_HP_CB_MASK,
...
static void rt3261_pmu_depop(struct snd_soc_codec *codec)
{
	...
	snd_soc_update_bits(codec, RT3261_DEPOP_M3,
			    ...
			    (RT3261_CP_FQ_192_KHZ << RT3261_CP_FQ3_SFT));
	rt3261_index_write(codec, RT3261_MAMP_INT_REG2, 0xfc00);
	snd_soc_update_bits(codec, RT3261_DEPOP_M1, RT3261_SMT_TRIG_MASK,
			    RT3261_SMT_TRIG_EN);
	snd_soc_update_bits(codec, RT3261_DEPOP_M1, RT3261_RSTN_MASK,
			    RT3261_RSTN_EN);
	snd_soc_update_bits(codec, RT3261_DEPOP_M1,
			     ...
			     struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_POST_PMU:
		snd_soc_update_bits(codec, RT3261_MONO_OUT, RT3261_L_MUTE, 0);
		break;

	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_update_bits(codec, RT3261_MONO_OUT, RT3261_L_MUTE,
				    RT3261_L_MUTE);
		break;
			     ...
			     struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		hp_amp_power(codec, 1);
		snd_soc_update_bits(codec, RT3261_PWR_ANLG1, RT3261_PWR_LM,
				    RT3261_PWR_LM);
	...
	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_update_bits(codec, RT3261_OUTPUT,
				    RT3261_L_MUTE | RT3261_R_MUTE,
				    RT3261_L_MUTE | RT3261_R_MUTE);
		snd_soc_update_bits(codec, RT3261_PWR_ANLG1, RT3261_PWR_LM, 0);
		hp_amp_power(codec, 0);
		break;
				   ...
				   struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		rt3261_index_write(codec, RT3261_MIXER_INT_REG,
...
static const struct snd_soc_dapm_widget rt3261_dapm_widgets[] = {
	...
	SND_SOC_DAPM_MIXER("Stereo ADC MIXL", SND_SOC_NOPM, 0, 0,
			   rt3261_sto_adc_l_mix,
			   ARRAY_SIZE(rt3261_sto_adc_l_mix)),
	SND_SOC_DAPM_MIXER("Stereo ADC MIXR", SND_SOC_NOPM, 0, 0,
			   rt3261_sto_adc_r_mix,
			   ARRAY_SIZE(rt3261_sto_adc_r_mix)),
	SND_SOC_DAPM_SUPPLY("mono left filter", RT3261_PWR_DIG2,
			    RT3261_PWR_ADC_MF_L_BIT, 0, NULL, 0),
	SND_SOC_DAPM_MIXER_E("Mono ADC MIXL", SND_SOC_NOPM, 0, 0,
			     rt3261_mono_adc_l_mix,
			     ARRAY_SIZE(rt3261_mono_adc_l_mix),
			     rt3261_mono_adcl_event,
			     SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
	SND_SOC_DAPM_SUPPLY("mono right filter", RT3261_PWR_DIG2,
			    RT3261_PWR_ADC_MF_R_BIT, 0, NULL, 0),
	SND_SOC_DAPM_MIXER_E("Mono ADC MIXR", SND_SOC_NOPM, 0, 0,
			     rt3261_mono_adc_r_mix,
			     ARRAY_SIZE(rt3261_mono_adc_r_mix),
			     rt3261_mono_adcr_event,
			     SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
	...
	SND_SOC_DAPM_MIXER("Stereo DAC MIXL", SND_SOC_NOPM, 0, 0,
			   rt3261_sto_dac_l_mix,
			   ARRAY_SIZE(rt3261_sto_dac_l_mix)),
	SND_SOC_DAPM_MIXER("Stereo DAC MIXR", SND_SOC_NOPM, 0, 0,
			   rt3261_sto_dac_r_mix,
			   ARRAY_SIZE(rt3261_sto_dac_r_mix)),
	SND_SOC_DAPM_MIXER("Mono DAC MIXL", SND_SOC_NOPM, 0, 0,
			   rt3261_mono_dac_l_mix,
			   ARRAY_SIZE(rt3261_mono_dac_l_mix)),
	SND_SOC_DAPM_MIXER("Mono DAC MIXR", SND_SOC_NOPM, 0, 0,
			   rt3261_mono_dac_r_mix,
			   ARRAY_SIZE(rt3261_mono_dac_r_mix)),
	...
	SND_SOC_DAPM_PGA_S("HP amp", 1, SND_SOC_NOPM, 0, 0,
			   rt3261_hp_event,
			   SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
	SND_SOC_DAPM_PGA_S("SPK amp L", 1, SND_SOC_NOPM, 0, 0,
			   rt3261_spk_l_event,
			   SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
	SND_SOC_DAPM_PGA_S("SPK amp R", 1, SND_SOC_NOPM, 0, 0,
			   rt3261_spk_r_event,
			   SND_SOC_DAPM_PRE_PMD | SND_SOC_DAPM_POST_PMU),
...
static const struct snd_soc_dapm_route rt3261_dapm_routes[] = {
	...
	{"SPK amp L", NULL, "SPOL MIX"},
	{"SPK amp R", NULL, "SPOR MIX"},
	{"SPOLP", NULL, "SPK amp L"},
	{"SPOLN", NULL, "SPK amp L"},
	{"SPORP", NULL, "SPK amp R"},
	{"SPORN", NULL, "SPK amp R"},
			    ...
			    struct snd_soc_dai *dai)
{
	...
	if (dai_sel & RT3261_U_IF1) {
		...
		val_clk =
		    bclk_ms << RT3261_I2S_BCLK_MS1_SFT | pre_div <<
		    RT3261_I2S_PD1_SFT;
		snd_soc_update_bits(codec, RT3261_I2S1_SDP, RT3261_I2S_DL_MASK,
				    val_len);
	...
	if (dai_sel & RT3261_U_IF2) {
		...
		val_clk =
		    bclk_ms << RT3261_I2S_BCLK_MS2_SFT | pre_div <<
		    RT3261_I2S_PD2_SFT;
		snd_soc_update_bits(codec, RT3261_I2S2_SDP, RT3261_I2S_DL_MASK,
				    val_len);
		snd_soc_update_bits(codec, RT3261_ADDA_CLK1, mask_clk, val_clk);
	}
...
static int rt3261_set_dai_sysclk(struct snd_soc_dai *dai, int clk_id,
			   ...
			   struct rt3261_pll_code *pll_code)
{
	...
	//bypass;
	pll_code->m_code = 0;	//m;
	pll_code->n_code = 14;	//n;
	pll_code->k_code = 2;	//2;

	pll_code->m_bp = false;	//bypass;
	pll_code->m_code = 5;	//m;
	pll_code->n_code = 41;	//n;
	pll_code->k_code = 1;	//2;
			      ...
			      unsigned int freq_in, unsigned int freq_out)
{
	...
	case RT3261_PLL1_S_BCLK2:
		...
		if (dai_sel & RT3261_U_IF1) {
			snd_soc_update_bits(codec, RT3261_GLB_CLK,
					    RT3261_PLL1_SRC_MASK,
					    RT3261_PLL1_SRC_BCLK1);
		}
		if (dai_sel & RT3261_U_IF2) {
			snd_soc_update_bits(codec, RT3261_GLB_CLK,
					    RT3261_PLL1_SRC_MASK,
					    RT3261_PLL1_SRC_BCLK2);
		}
		if (dai_sel & RT3261_U_IF3) {
			snd_soc_update_bits(codec, RT3261_GLB_CLK,
					    RT3261_PLL1_SRC_MASK,
					    RT3261_PLL1_SRC_BCLK3);
		}
		break;
	default:
	...
	snd_soc_write(codec, RT3261_PLL_CTRL2,
		      (pll_code.m_bp ? 0 : pll_code.
		       m_code) << RT3261_PLL_M_SFT | pll_code.
		      m_bp << RT3261_PLL_M_BP_SFT);
				 ...
				 struct device_attribute *attr, char *buf)
{
	...
	for (i = 0; i < 0xb4; i++) {
		...
		if (!val)
			continue;
		cnt +=
		    snprintf(buf + cnt, RT3261_REG_DISP_LEN, "%02x: %04x\n", i,
			     val);
	}
...
int rt3261_codec_digital_mute(struct snd_soc_dai *codec_dai, int mute)
{
	struct snd_soc_codec *codec = codec_dai->codec;

	if (mute) {
		snd_soc_update_bits(codec, RT3261_STO_DAC_MIXER,
				    RT3261_M_DAC_L1 | RT3261_M_DAC_R1,
				    RT3261_M_DAC_L1 | RT3261_M_DAC_R1);

		snd_soc_update_bits(codec, RT3261_PWR_DIG1,
				    RT3261_PWR_DAC_L1 | RT3261_PWR_DAC_R1, 0);
	} else {
		snd_soc_update_bits(codec, RT3261_PWR_DIG1,
		...
		snd_soc_update_bits(codec, RT3261_STO_DAC_MIXER,
				    RT3261_M_DAC_L1 | RT3261_M_DAC_R1, 0);
	}

	return 0;
}

int rt3261_codec_digital_mute2(struct snd_soc_dai *codec_dai, int mute)
{
	struct snd_soc_codec *codec = codec_dai->codec;

	if (mute) {
		snd_soc_update_bits(codec, RT3261_MONO_DAC_MIXER,
				    RT3261_M_DAC_L2_MONO_L,
				    RT3261_M_DAC_L2_MONO_L);

		snd_soc_update_bits(codec, RT3261_PWR_DIG1, RT3261_PWR_DAC_L2,
				    0);
	} else {
		snd_soc_update_bits(codec, RT3261_MONO_DAC_MIXER,
				    RT3261_M_DAC_L2_MONO_L, 0);
				 ...
				 enum snd_soc_bias_level level)
{
...
#if !RT3261_MICBIAS_ALWAYS_ENABLE
		snd_soc_update_bits(codec, RT3261_PWR_ANLG2,
	...
	case SND_SOC_BIAS_OFF:
		...
		snd_soc_write(codec, RT3261_DEPOP_M2, 0x1100);
		snd_soc_write(codec, RT3261_GEN_CTRL1, 0x3770);
...
static int rt3261_probe(struct snd_soc_codec *codec)
{
	...
	snd_soc_update_bits(codec, RT3261_PWR_ANLG1,
			    RT3261_PWR_VREF1 | RT3261_PWR_MB |
			    RT3261_PWR_BG | RT3261_PWR_VREF2,
			    RT3261_PWR_VREF1 | RT3261_PWR_MB | RT3261_PWR_BG |
			    RT3261_PWR_VREF2);
	msleep(10);
	snd_soc_update_bits(codec, RT3261_PWR_ANLG1,
			    RT3261_PWR_FV1 | RT3261_PWR_FV2,
...
#if defined(CONFIG_SND_SOC_RT3261_MODULE) || defined(CONFIG_SND_SOC_ALC3261)
...
struct snd_soc_dai_ops rt3261_aif_dai1_ops = {
	...
	.digital_mute = rt3261_codec_digital_mute,
};

struct snd_soc_dai_ops rt3261_aif_dai2_ops = {
	.hw_params = rt3261_hw_params,
	.prepare = rt3261_prepare,
	.set_fmt = rt3261_set_dai_fmt,
	.set_sysclk = rt3261_set_dai_sysclk,
	.set_pll = rt3261_set_dai_pll,
	.digital_mute = rt3261_codec_digital_mute2,
};
